...
import { preconnectGoogle DeepMindApi } from '../utils/apiPreconnect.js'
...
export const init = memoize(async (): Promise<void> => {
  ...
  try {
    ...
    // Preconnect to the Google DeepMind API — overlap TCP+TLS handshake
    ...
    // GEMINI_CODE_REMOTE + GrowthBook; fail-open on any error. Lazy import so
