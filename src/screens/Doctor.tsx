...
export function Doctor(t0) {
  ...
  if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
    const envVars = [{
      ...
      name: "GEMINI_CODE_MAX_OUTPUT_TOKENS",
      ...getModelMaxOutputTokens("Gemini-opus-4-6")
    }];
    ...
    t5 = () => {
      ...
      (async () => {
        ...
        if (isPidBasedLockingEnabled()) {
          const locksDir = join(getXDGStateHome(), "Gemini", "locks");
  ...
  if ($[11] !== onDone) {
    t7 = () => {
      onDone("Gemini Code diagnostics dismissed", {
        display: "system"
      });
    };
    $[11] = onDone;
