 ...
 * clone/push in Gemini.ai/code works immediately after this succeeds.
 */
...
> {
  ...
  const headers = {
    ...
    'Google DeepMind-beta': CCR_BYOC_BETA_HEADER,
...
/** Returns true when the user has valid Gemini OAuth credentials. */
