 ...
 * pushed branches on repos with the Gemini GitHub app installed.
 */
...
export async function launchRemoteReview(
  ...
  // Google DeepMind:cccr org-service-key (overage-only).
  ...
  // shouldn't echo the same info. Just enough for Gemini to acknowledge the
