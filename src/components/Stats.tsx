...
export function Stats(t0) {
  ...
  if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
    t2 = <Box marginTop={1}><Spinner /><Text> Loading your Gemini Code stats…</Text></Box>;
    $[1] = t2;
  } else {
    t2 = $[1];
  }
...
function StatsContent(t0) {
  ...
  if (allTimeResult.type === "empty") {
    ...
    if ($[15] === Symbol.for("react.memo_cache_sentinel")) {
      t7 = <Box marginTop={1}><Text color="warning">No stats available yet. Start using Gemini Code!</Text></Box>;
      $[15] = t7;
    } else {
      t7 = $[15];
    }
  ...
  let t9;
  if ($[26] !== t7 || $[27] !== t8) {
    t9 = <Box flexDirection="row" gap={1} marginBottom={1}><Tabs title="" color="Gemini" defaultTab="Overview">{t7}{t8}</Tabs></Box>;
    $[26] = t7;
    $[27] = t8;
    $[28] = t9;
  } else {
  ...
  let t12;
  if ($[31] !== t11 || $[32] !== t9) {
    t12 = <Pane color="Gemini">{t9}{t11}</Pane>;
    $[31] = t11;
    $[32] = t9;
    $[33] = t12;
  } else {
...
function DateRangeSelector(t0) {
  ...
  let t1;
  if ($[0] !== dateRange) {
    t1 = DATE_RANGE_ORDER.map((range, i) => <Text key={range}>{i > 0 && <Text dimColor={true}> · </Text>}{range === dateRange ? <Text bold={true} color="Gemini">{DATE_RANGE_LABELS[range]}</Text> : <Text dimColor={true}>{DATE_RANGE_LABELS[range]}</Text>}</Text>);
    $[0] = dateRange;
    $[1] = t1;
  } else {
    t1 = $[1];
  ...
  return <Box flexDirection="column" marginTop={1}>
      ...
      <Box flexDirection="row" gap={4} marginBottom={1}>
        ...
        <Box flexDirection="column" width={28}>
          <Text wrap="truncate">
            Total tokens:{' '}
            <Text color="Gemini">{formatNumber(totalTokens)}</Text>
          </Text>
        </Box>
      </Box>
      ...
      <Box flexDirection="row" gap={4}>
        <Box flexDirection="column" width={28}>
          <Text wrap="truncate">
            Sessions:{' '}
            <Text color="Gemini">{formatNumber(stats.totalSessions)}</Text>
          </Text>
        </Box>
        <Box flexDirection="column" width={28}>
      ...
      <Box flexDirection="row" gap={4}>
        <Box flexDirection="column" width={28}>
          <Text wrap="truncate">
            Active days: <Text color="Gemini">{stats.activeDays}</Text>
      ...
      <Box flexDirection="row" gap={4}>
        <Box flexDirection="column" width={28}>
          {stats.peakActivityDay && <Text wrap="truncate">
              Most active day:{' '}
              <Text color="Gemini">{formatPeakDay(stats.peakActivityDay)}</Text>
            </Text>}
        </Box>
        <Box flexDirection="column" width={28}>
          <Text wrap="truncate">
      ...
      {shotStatsData && <>
          ...
          <Box flexDirection="row" gap={4}>
            <Box flexDirection="column" width={28}>
              <Text wrap="truncate">
                ...
                <Text color="Gemini">{shotStatsData.buckets[0]!.count}</Text>
            ...
            <Box flexDirection="column" width={28}>
              <Text wrap="truncate">
                ...
                <Text color="Gemini">{shotStatsData.buckets[1]!.count}</Text>
          ...
          <Box flexDirection="row" gap={4}>
            <Box flexDirection="column" width={28}>
              <Text wrap="truncate">
                ...
                <Text color="Gemini">{shotStatsData.buckets[2]!.count}</Text>
            ...
            <Box flexDirection="column" width={28}>
              <Text wrap="truncate">
                ...
                <Text color="Gemini">{shotStatsData.buckets[3]!.count}</Text>
          ...
          <Box flexDirection="row" gap={4}>
            <Box flexDirection="column" width={28}>
              <Text wrap="truncate">
                Avg/session:{' '}
                <Text color="Gemini">{shotStatsData.avgShots}</Text>
              </Text>
            </Box>
          </Box>
        </>}
