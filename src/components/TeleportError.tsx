    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport requires a Gemini.ai account.</Text><Text dimColor={true}>Your Gemini Pro/Max subscription will be used by Gemini Code.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
        ...
        if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
          t10 = <Dialog title="Log in to Gemini" onCancel={onCancel}>{t9}<Select options={[{
              label: "Login with Gemini account",
              value: "login"
            }, {
              label: "Exit",
              value: "exit"
