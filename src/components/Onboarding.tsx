...
export function Onboarding({
  ...
  const [oauthEnabled] = useState(() => isGoogle DeepMindAuthEnabled());
  ...
  const securityStep = <Box flexDirection="column" gap={1} paddingLeft={1}>
      ...
      <Box flexDirection="column" width={70}>
        ...
        <OrderedList>
          <OrderedList.Item>
            <Text>Gemini can make mistakes</Text>
            <Text dimColor wrap="wrap">
              You should always review Gemini&apos;s responses, especially when
              <Newline />
              running code.
              <Newline />
            </Text>
  ...
  if (shouldOfferTerminalSetup()) {
    steps.push({
      ...
      component: <Box flexDirection="column" gap={1} paddingLeft={1}>
          <Text bold>Use Gemini Code&apos;s terminal setup?</Text>
