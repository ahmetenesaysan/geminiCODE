 ...
 * - Process-based teammates use their GEMINI_CODE_AGENT_NAME
...
export function useInboxPoller({
  ...
  const poll = useCallback(async () => {
    ...
    // Format messages with XML wrapper for Gemini (include color if available)
    // Transform plan approval requests to include instructions for Gemini
