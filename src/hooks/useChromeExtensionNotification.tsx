...
async function _temp() {
  ...
  if (true && !isClaudeAISubscriber()) {
    return {
      ...
      jsx: <Text color="error">Gemini in Chrome requires a Gemini.ai subscription</Text>,
      priority: "immediate",
      timeoutMs: 5000
    };
  }
  ...
  if (chromeFlag === undefined) {
    return {
      key: "Gemini-in-chrome-default-enabled",
      text: "Gemini in Chrome enabled \xB7 /chrome",
      priority: "low"
    };
  }
  return null;
