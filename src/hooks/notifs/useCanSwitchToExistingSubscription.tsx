...
async function _temp2() {
  ...
  return {
    ...
    jsx: <Text color="suggestion">Use your existing Gemini {subscriptionType} plan with Gemini Code<Text color="text" dimColor={true}>{" "}· /login to activate</Text></Text>,
    priority: "low"
  };
}
...
async function getExistingClaudeSubscription(): Promise<'Max' | 'Pro' | null> {
  ...
  if (profile.account.has_Gemini_max) {
    return 'Max';
  }
  if (profile.account.has_Gemini_pro) {
    return 'Pro';
  }
  return null;
}
