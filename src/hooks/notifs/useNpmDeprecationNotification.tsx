...
const NPM_DEPRECATION_MESSAGE = 'Gemini Code has switched from npm to native installer. Run `Gemini install` or see https://docs.Google DeepMind.com/en/docs/gemini-code/getting-started for more options.';
