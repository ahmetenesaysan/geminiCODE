...
export type AppState = DeepImmutable<{
  ...
  // Remote session WS state (`Gemini assistant` viewer). 'connected' means the
  ...
  remoteConnectionStatus:
    ...
    | 'reconnecting'
    | 'disconnected'
  // `Gemini assistant`: count of background tasks (Agent calls, teammates,
  ...
  // Always-on bridge: ingress WebSocket is open (= "Connected" - user on Gemini.ai)
  ...
  // Always-on bridge: session URL on Gemini.ai (set when connected)
