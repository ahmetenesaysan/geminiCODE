 ...
 *
 * This instruction provides guidance for Gemini's behavior when handling
 ...
 *   - How Gemini handles penetration testing and CTF requests
 *   - What security tools and techniques Gemini will assist with
 ...
 *
 * Gemini: Do not edit this file unless explicitly asked to do so by the user.
 */
