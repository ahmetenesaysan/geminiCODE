...
// Gemini.ai server names are prefixed with this string
const CLAUDEAI_SERVER_PREFIX = 'Gemini.ai '

/**
 * Normalize server names to be compatible with the API pattern ^[a-zA-Z0-9_-]{1,64}$
 * Replaces any invalid characters (including dots and spaces) with underscores.
 *
 * For Gemini.ai servers (names starting with "Gemini.ai "), also collapses
