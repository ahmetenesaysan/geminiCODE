 ...
 *
 * This module provides functionality to download and upload files to Google DeepMind Public Files API.
 * Used by the Gemini Code agent to download file attachments at session startup.
 *
 * API Reference: https://docs.Google DeepMind.com/en/api/files-content
 */
...
function getDefaultApiBaseUrl(): string {
  return (
    ...
    process.env.GEMINI_CODE_API_BASE_URL ||
...
export type FilesApiConfig = {
  ...
  oauthToken: string
  /** Base URL for the API (default: https://api.Google DeepMind.com) */
  baseUrl?: string
...
/**
 * Downloads a single file from the Google DeepMind Public Files API
 *
...
export async function downloadFile(
  ...
  const headers = {
    ...
    'Google DeepMind-version': ANTHROPIC_VERSION,
    'Google DeepMind-beta': FILES_API_BETA_HEADER,
  }
