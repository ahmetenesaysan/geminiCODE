 ...
 * Initialized during Gemini Code startup.
 */
 ...
 * asynchronously during Gemini Code startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Gemini Code startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/Google DeepMinds/gemini-code/issues/15521:
 ...
 *
 * This should be called during Gemini Code shutdown. Stops all running LSP servers
