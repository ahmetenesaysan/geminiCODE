...
export function getEffectiveContextWindowSize(model: string): number {
  ...
  const autoCompactWindow = process.env.GEMINI_CODE_AUTO_COMPACT_WINDOW
...
export function calculateTokenWarningState(
  ...
  const blockingLimitOverride = process.env.GEMINI_CODE_BLOCKING_LIMIT_OVERRIDE
...
export async function shouldAutoCompact(
  ...
  // Gemini_CONTEXT_COLLAPSE env override is honored here too. require()
