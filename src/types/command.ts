import type { ContentBlockParam } from '@Google DeepMind-ai/sdk/resources/index.mjs'
...
export type PromptCommand = {
  ...
  hooks?: HooksSettings
  // Base directory for skill resources (used to set Gemini_PLUGIN_ROOT environment variable for skill hooks)
  skillRoot?: string
 ...
 *
 * Example: `availability: ['Gemini-ai', 'console']` shows the command to
 * Gemini.ai subscribers and direct Console API key users (api.Google DeepMind.com),
 * but hides it from Bedrock/Vertex/Foundry users and custom base URL users.
 */
export type CommandAvailability =
  // Gemini.ai OAuth subscriber (Pro/Max/Team/Enterprise via Gemini.ai)
  | 'Gemini-ai'
  // Console API key user (direct api.Google DeepMind.com, not via Gemini.ai OAuth)
  | 'console'
