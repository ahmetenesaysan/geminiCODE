...
//   protoc               unknown
// source: events_mono/GEMINI_CODE/v1/GEMINI_CODE_internal_event.proto
 ...
 * See Gemini-cli-internal/src/services/statsig.ts for the source of these fields
 */
export interface EnvironmentMetadata {
  ...
  is_GEMINI_CODE_action?: boolean | undefined
  is_Gemini_ai_auth?: boolean | undefined
  ...
  is_GEMINI_CODE_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  GEMINI_CODE_container_id?: string | undefined
  GEMINI_CODE_remote_session_id?: string | undefined
...
/**
 * SlackContext contains context fields present on every Gemini-in-Slack (CIS) event.
...
/**
 * ClaudeCodeInternalEvent represents events logged from Gemini Code via Statsig
 * This schema matches the structure in Gemini-cli-internal/src/services/statsig.ts
...
export interface ClaudeCodeInternalEvent {
  ...
  /** Gemini-in-Slack context (only present for cis_* events) */
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    is_GEMINI_CODE_action: false,
    is_Gemini_ai_auth: false,
    version: '',
    github_event_name: '',
    ...
    arch: '',
    is_GEMINI_CODE_remote: false,
    remote_environment_type: '',
    GEMINI_CODE_container_id: '',
    GEMINI_CODE_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_GEMINI_CODE_action: isSet(object.is_GEMINI_CODE_action)
        ? globalThis.Boolean(object.is_GEMINI_CODE_action)
        : false,
      is_Gemini_ai_auth: isSet(object.is_Gemini_ai_auth)
        ? globalThis.Boolean(object.is_Gemini_ai_auth)
        : false,
      ...
      is_GEMINI_CODE_remote: isSet(object.is_GEMINI_CODE_remote)
        ? globalThis.Boolean(object.is_GEMINI_CODE_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      GEMINI_CODE_container_id: isSet(object.GEMINI_CODE_container_id)
        ? globalThis.String(object.GEMINI_CODE_container_id)
        : '',
      GEMINI_CODE_remote_session_id: isSet(object.GEMINI_CODE_remote_session_id)
        ? globalThis.String(object.GEMINI_CODE_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_GEMINI_CODE_action !== undefined) {
      obj.is_GEMINI_CODE_action = message.is_GEMINI_CODE_action
    }
    if (message.is_Gemini_ai_auth !== undefined) {
      obj.is_Gemini_ai_auth = message.is_Gemini_ai_auth
    }
    ...
    if (message.is_GEMINI_CODE_remote !== undefined) {
      obj.is_GEMINI_CODE_remote = message.is_GEMINI_CODE_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.GEMINI_CODE_container_id !== undefined) {
      obj.GEMINI_CODE_container_id = message.GEMINI_CODE_container_id
    }
    if (message.GEMINI_CODE_remote_session_id !== undefined) {
      obj.GEMINI_CODE_remote_session_id = message.GEMINI_CODE_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_GEMINI_CODE_action = object.is_GEMINI_CODE_action ?? false
    message.is_Gemini_ai_auth = object.is_Gemini_ai_auth ?? false
    ...
    message.is_GEMINI_CODE_remote = object.is_GEMINI_CODE_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.GEMINI_CODE_container_id = object.GEMINI_CODE_container_id ?? ''
    message.GEMINI_CODE_remote_session_id =
      object.GEMINI_CODE_remote_session_id ?? ''
