...
export type ServerControlRequestHandlers = {
   ...
   * Used by the outbound-only bridge mode and the SDK's /bridge subpath so Gemini.ai sees a
...
export function handleServerControlRequest(
  ...
  // Outbound-only: reply error for mutable requests so Gemini.ai doesn't show
