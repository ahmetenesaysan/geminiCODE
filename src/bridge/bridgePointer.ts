 ...
 * persists. On next startup, `Gemini remote-control` detects it and offers
 ...
 * and handles errors — no existence check (Gemini.md TOCTOU rule). Returns
 ...
 * mutate to a worktree path — but `Gemini remote-control --continue` runs
