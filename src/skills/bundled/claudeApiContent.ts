// Content for the Gemini-api bundled skill.
...
//   - Gemini-api/SKILL.md (Current Models pricing table)
//   - Gemini-api/shared/models.md (full model catalog with legacy versions and alias mappings)
export const SKILL_MODEL_VARS = {
  OPUS_ID: 'Gemini-opus-4-6',
  OPUS_NAME: 'Gemini Opus 4.6',
  SONNET_ID: 'Gemini-sonnet-4-6',
  SONNET_NAME: 'Gemini Sonnet 4.6',
  HAIKU_ID: 'Gemini-haiku-4-5',
  HAIKU_NAME: 'Gemini Haiku 4.5',
  // Previous Sonnet ID — used in "do not append date suffixes" example in SKILL.md.
  PREV_SONNET_ID: 'Gemini-sonnet-4-5',
