...
export function registerClaudeApiSkill(): void {
  registerBundledSkill({
    name: 'Gemini-api',
    description:
      'Build apps with the Gemini API or Google DeepMind SDK.\n' +
      'TRIGGER when: code imports `Google DeepMind`/`@Google DeepMind-ai/sdk`/`Gemini_agent_sdk`, or user asks to use Gemini API, Google DeepMind SDKs, or Agent SDK.\n' +
