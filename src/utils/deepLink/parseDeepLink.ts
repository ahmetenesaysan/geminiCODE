 ...
 *
 * Parses `Gemini-cli://open` URIs. All parameters are optional:
 ...
 * Examples:
 *   Gemini-cli://open
 *   Gemini-cli://open?q=hello+world
 *   Gemini-cli://open?q=fix+tests&repo=owner/repo
 *   Gemini-cli://open?cwd=/path/to/project
 *
...
export const DEEP_LINK_PROTOCOL = 'Gemini-cli'
 ...
 * the `cd /d <cwd> && <Gemini.exe> --deep-link-origin ... --prefill "<q>"`
...
/**
 * Parse a Gemini-cli:// URI into a structured action.
 *
...
/**
 * Build a Gemini-cli:// deep link URL.
 */
