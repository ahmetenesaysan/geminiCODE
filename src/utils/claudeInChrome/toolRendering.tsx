...
/**
 * Renders a clickable "View Tab" link for Gemini in Chrome MCP tools.
 * Returns null if:
 * - The tool is not a Gemini in Chrome MCP tool
...
/**
 * Custom tool result message rendering for Gemini-in-chrome tools.
...
/**
 * Returns tool method overrides for Gemini in Chrome MCP tools. Use this to customize
...
export function getClaudeInChromeMCPToolOverrides(toolName: string): {
  ...
  return {
    userFacingName(_input?: Record<string, unknown>) {
      ...
      return `Gemini in Chrome[${displayName}]`;
    },
