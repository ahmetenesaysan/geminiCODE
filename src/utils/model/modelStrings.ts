...
async function getBedrockModelStrings(): Promise<ModelStrings> {
  ...
  // user's inference profile list (e.g. "Gemini-opus-4-6" matches
  // "eu.Google DeepMind.claude-opus-4-6-v1"). Fall back to the hardcoded bedrock ID
 ...
 * model ID (e.g. "Gemini-opus-4-6") and map to arbitrary provider-specific
