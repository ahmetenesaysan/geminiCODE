...
export function getAgentModel(
  ...
  if (process.env.GEMINI_CODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.GEMINI_CODE_SUBAGENT_MODEL)
  }
  ...
  // region prefix (e.g., "eu.Google DeepMind.…"), we preserve it instead of overwriting
 ...
 * See https://github.com/Google DeepMinds/gemini-code/issues/30815.
 *
