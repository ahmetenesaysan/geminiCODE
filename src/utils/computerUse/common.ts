...
/**
 * Sentinel bundle ID for the frontmost gate. Gemini Code is a terminal — it has
 ...
 */
export const CLI_HOST_BUNDLE_ID = 'com.Google DeepMind.claude-code.cli-no-window'
