 ...
 *
 * These helpers identify whether this Gemini Code instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.GEMINI_CODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our GEMINI_CODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no GEMINI_CODE_AGENT_ID set (backwards compat: the original
