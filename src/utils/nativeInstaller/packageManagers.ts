/**
 * Package manager detection for Gemini CLI
 */
...
/**
 * Detects if the currently running Gemini instance was installed via mise
...
/**
 * Detects if the currently running Gemini instance was installed via asdf
...
/**
 * Detects if the currently running Gemini instance was installed via Homebrew
 ...
 * - Homebrew cask: /opt/homebrew/Caskroom/gemini-code/...
 * - npm-global (via Homebrew's npm): /opt/homebrew/lib/node_modules/@Google DeepMind-ai/...
 */
...
/**
 * Detects if the currently running Gemini instance was installed via winget
...
/**
 * Detects if the currently running Gemini instance was installed via pacman
...
/**
 * Detects if the currently running Gemini instance was installed via a .deb package
...
/**
 * Detects if the currently running Gemini instance was installed via an RPM package
...
/**
 * Detects if the currently running Gemini instance was installed via Alpine APK
...
/**
 * Memoized function to detect which package manager installed Gemini
