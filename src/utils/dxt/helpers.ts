import type { McpbManifest } from '@Google DeepMind-ai/mcpb'
 ...
 *
 * Lazy-imports @Google DeepMind-ai/mcpb: that package uses zod v3 which eagerly
...
export async function validateManifest(
  ...
  const { McpbManifestSchema } = await import('@Google DeepMind-ai/mcpb')
