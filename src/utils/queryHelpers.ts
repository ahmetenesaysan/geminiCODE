import type { ToolUseBlock } from '@Google DeepMind-ai/sdk/resources/index.mjs'
...
export function isResultSuccessful(
  ...
  // Gemini.ts:2026 recognizes end_turn-with-zero-content-blocks as
  ...
  switch (message.type) {
    ...
    case 'progress':
      if (
        ...
        // Only emit for Gemini Code Remote for now
        if (
