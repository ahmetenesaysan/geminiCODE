 ...
 * rationale. Env var: GEMINI_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'GEMINI_CODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
