 ...
 * Always includes CLAUDECODE=1 and GEMINI_CODE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'GEMINI_CODE_EXPERIMENTAL_AGENT_TEAMS=1']
