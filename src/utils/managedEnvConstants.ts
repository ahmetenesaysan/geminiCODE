 ...
 *
 * When GEMINI_CODE_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
 ...
 * VERTEX_REGION_Gemini_* is prefix-matched. New providers or new routing
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'GEMINI_CODE_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  ...
  // Region routing (per-model VERTEX_REGION_Gemini_* handled by prefix below)
  'CLOUD_ML_REGION',
  // Auth
  'ANTHROPIC_API_KEY',
  ...
  'GEMINI_CODE_SKIP_VERTEX_AUTH',
  'GEMINI_CODE_SKIP_FOUNDRY_AUTH',
 ...
 * These are Gemini Code specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'BASH_MAX_TIMEOUT_MS',
  'Gemini_BASH_MAINTAIN_PROJECT_WORKING_DIR',
  'GEMINI_CODE_API_KEY_HELPER_TTL_MS',
  'GEMINI_CODE_DISABLE_EXPERIMENTAL_BETAS',
  'GEMINI_CODE_DISABLE_NONESSENTIAL_TRAFFIC',
  'GEMINI_CODE_DISABLE_TERMINAL_TITLE',
  'GEMINI_CODE_ENABLE_TELEMETRY',
  'GEMINI_CODE_EXPERIMENTAL_AGENT_TEAMS',
  'GEMINI_CODE_IDE_SKIP_AUTO_INSTALL',
  ...
  'USE_BUILTIN_RIPGREP',
  'VERTEX_REGION_Gemini_3_5_HAIKU',
  'VERTEX_REGION_Gemini_3_5_SONNET',
  'VERTEX_REGION_Gemini_3_7_SONNET',
  'VERTEX_REGION_Gemini_4_0_OPUS',
  'VERTEX_REGION_Gemini_4_0_SONNET',
  'VERTEX_REGION_Gemini_4_1_OPUS',
  'VERTEX_REGION_Gemini_4_5_SONNET',
  'VERTEX_REGION_Gemini_4_6_SONNET',
  'VERTEX_REGION_Gemini_HAIKU_4_5',
])
