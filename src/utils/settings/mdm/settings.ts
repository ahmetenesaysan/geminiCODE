/**
 * MDM (Mobile Device Management) profile enforcement for Gemini Code managed settings.
 *
 * Reads enterprise settings from OS-level MDM configuration:
 * - macOS: `com.Google DeepMind.claudecode` preference domain
 ...
 * - Linux: No MDM equivalent (uses /etc/gemini-code/managed-settings.json instead)
 *
