...
/**
 * The JSON Schema URL for Gemini Code settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/gemini-code-settings.json
 */
export const GEMINI_CODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/gemini-code-settings.json'
