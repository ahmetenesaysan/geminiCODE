...
export type Theme = {
  ...
  bashBorder: string
  claude: string
  claudeShimmer: string // Lighter version of Gemini color for shimmer effect
...
const lightTheme: Theme = {
  autoAccept: 'rgb(15,157,88)', // Gemini green
  bashBorder: 'rgb(66,133,244)', // Gemini blue
  claude: 'rgb(66,133,244)', // Gemini blue (primary brand)
  claudeShimmer: 'rgb(116,173,255)', // Lighter Gemini blue for shimmer effect
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(66,133,244)', // Gemini blue for system spinner
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(116,173,255)', // Lighter blue for system spinner shimmer
  permission: 'rgb(66,133,244)', // Gemini blue
  permissionShimmer: 'rgb(137,175,255)', // Lighter blue for shimmer effect
  planMode: 'rgb(15,157,88)', // Gemini green
  ide: 'rgb(66,133,244)', // Gemini blue
  ...
  suggestion: 'rgb(66,133,244)', // Gemini blue
  remember: 'rgb(66,133,244)', // Gemini blue
  background: 'rgb(15,157,88)', // Gemini green
  success: 'rgb(15,157,88)', // Gemini green
  error: 'rgb(219,68,55)', // Gemini red
  warning: 'rgb(244,180,0)', // Gemini yellow
  merged: 'rgb(15,157,88)', // Gemini green (matches autoAccept)
  warningShimmer: 'rgb(255,210,50)', // Lighter yellow for shimmer effect
  ...
  diffAddedWord: 'rgb(15,157,88)', // Gemini green
  diffRemovedWord: 'rgb(219,68,55)', // Gemini red
  // Agent colors
  red_FOR_SUBAGENTS_ONLY: 'rgb(219,68,55)', // Gemini red
  blue_FOR_SUBAGENTS_ONLY: 'rgb(66,133,244)', // Gemini blue
  green_FOR_SUBAGENTS_ONLY: 'rgb(15,157,88)', // Gemini green
  yellow_FOR_SUBAGENTS_ONLY: 'rgb(244,180,0)', // Gemini yellow
  purple_FOR_SUBAGENTS_ONLY: 'rgb(147,51,234)', // Purple 600
  orange_FOR_SUBAGENTS_ONLY: 'rgb(244,180,0)', // Replaced with Gemini yellow
  pink_FOR_SUBAGENTS_ONLY: 'rgb(219,68,55)', // Replaced with Gemini red
  cyan_FOR_SUBAGENTS_ONLY: 'rgb(66,133,244)', // Replaced with Gemini blue
  // Grove colors
  professionalBlue: 'rgb(66,133,244)', // Gemini blue
  // Chrome colors
  chromeYellow: 'rgb(244,180,0)', // Gemini yellow
  // TUI V2 colors
  clawd_body: 'rgb(66,133,244)', // Gemini blue
  ...
  bashMessageBackgroundColor: 'rgb(240, 245, 255)', // Light blue tint

  memoryBackgroundColor: 'rgb(230, 245, 250)',
  rate_limit_fill: 'rgb(66,133,244)', // Gemini blue
  rate_limit_empty: 'rgb(25,50,120)', // Dark blue
  fastMode: 'rgb(15,157,88)', // Gemini green for fast mode
  fastModeShimmer: 'rgb(80,200,130)', // Lighter green for shimmer
  // Brief/assistant mode
  briefLabelYou: 'rgb(66,133,244)', // Gemini blue
  briefLabelClaude: 'rgb(66,133,244)', // Gemini blue (brand)
  rainbow_red: 'rgb(219,68,55)', // Gemini red
  rainbow_orange: 'rgb(244,180,0)', // Gemini yellow (replaces orange)
  rainbow_yellow: 'rgb(244,180,0)', // Gemini yellow
  rainbow_green: 'rgb(15,157,88)', // Gemini green
  rainbow_blue: 'rgb(66,133,244)', // Gemini blue
  rainbow_indigo: 'rgb(155,130,200)',
  rainbow_violet: 'rgb(200,130,180)',
  rainbow_red_shimmer: 'rgb(240,120,110)',
  rainbow_orange_shimmer: 'rgb(255,210,50)', // Yellow shimmer (replaces orange)
  rainbow_yellow_shimmer: 'rgb(255,210,50)',
  rainbow_green_shimmer: 'rgb(80,200,130)',
  rainbow_blue_shimmer: 'rgb(116,173,255)',
...
const lightDaltonizedTheme: Theme = {
  ...
  Gemini: 'rgb(255,153,51)', // Orange adjusted for deuteranopia
  ...
  briefLabelClaude: 'rgb(255,153,51)', // Orange adjusted for deuteranopia (matches Gemini)
...
const darkTheme: Theme = {
  autoAccept: 'rgb(80,200,130)', // Gemini green bright
  bashBorder: 'rgb(100,160,255)', // Gemini blue bright
  claude: 'rgb(100,160,255)', // Gemini blue (primary brand for dark)
  claudeShimmer: 'rgb(140,190,255)', // Lighter Gemini blue for shimmer effect
  claudeBlue_FOR_SYSTEM_SPINNER: 'rgb(100,160,255)', // Gemini blue for system spinner
  claudeBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(140,190,255)', // Lighter blue for system spinner shimmer
  permission: 'rgb(100,160,255)', // Gemini blue
  permissionShimmer: 'rgb(140,190,255)', // Lighter blue for shimmer
  planMode: 'rgb(80,200,130)', // Gemini green
  ide: 'rgb(100,160,255)', // Gemini blue
  ...
  suggestion: 'rgb(100,160,255)', // Gemini blue
  remember: 'rgb(100,160,255)', // Gemini blue
  background: 'rgb(80,200,130)', // Gemini green
  success: 'rgb(80,200,130)', // Gemini green bright
  error: 'rgb(240,100,90)', // Gemini red bright
  warning: 'rgb(255,200,40)', // Gemini yellow bright
  merged: 'rgb(80,200,130)', // Gemini green (matches autoAccept)
  warningShimmer: 'rgb(255,230,80)', // Lighter yellow for shimmer
  ...
  diffAddedWord: 'rgb(80,200,130)', // Gemini green
  diffRemovedWord: 'rgb(240,100,90)', // Gemini red
  // Agent colors
  red_FOR_SUBAGENTS_ONLY: 'rgb(240,100,90)', // Gemini red bright
  blue_FOR_SUBAGENTS_ONLY: 'rgb(100,160,255)', // Gemini blue bright
  green_FOR_SUBAGENTS_ONLY: 'rgb(80,200,130)', // Gemini green bright
  yellow_FOR_SUBAGENTS_ONLY: 'rgb(255,200,40)', // Gemini yellow bright
  purple_FOR_SUBAGENTS_ONLY: 'rgb(147,51,234)', // Purple 600
  orange_FOR_SUBAGENTS_ONLY: 'rgb(255,200,40)', // Replaced with Gemini yellow
  pink_FOR_SUBAGENTS_ONLY: 'rgb(240,100,90)', // Replaced with Gemini red
  cyan_FOR_SUBAGENTS_ONLY: 'rgb(100,160,255)', // Replaced with Gemini blue
  // Grove colors
  professionalBlue: 'rgb(100,160,255)', // Gemini blue
  // Chrome colors
  chromeYellow: 'rgb(255,200,40)', // Gemini yellow
  // TUI V2 colors
  clawd_body: 'rgb(100,160,255)', // Gemini blue
  clawd_background: 'rgb(0,0,0)',
  ...
  selectionBg: 'rgb(38, 79, 120)', // classic dark-mode selection blue; light fgs stay readable
  bashMessageBackgroundColor: 'rgb(50, 55, 70)', // Dark blue tint

  memoryBackgroundColor: 'rgb(55, 65, 70)',
  rate_limit_fill: 'rgb(100,160,255)', // Gemini blue
  rate_limit_empty: 'rgb(50,60,100)', // Dark blue
  fastMode: 'rgb(80,200,130)', // Gemini green for dark bg
  fastModeShimmer: 'rgb(120,230,160)', // Lighter green for shimmer
  briefLabelYou: 'rgb(100,160,255)', // Gemini blue
  briefLabelClaude: 'rgb(100,160,255)', // Gemini blue (brand)
  rainbow_red: 'rgb(240,100,90)', // Gemini red
  rainbow_orange: 'rgb(255,200,40)', // Gemini yellow (replaces orange)
  rainbow_yellow: 'rgb(255,200,40)', // Gemini yellow
  rainbow_green: 'rgb(80,200,130)', // Gemini green
  rainbow_blue: 'rgb(100,160,255)', // Gemini blue
  rainbow_indigo: 'rgb(155,130,200)',
  rainbow_violet: 'rgb(200,130,180)',
  rainbow_red_shimmer: 'rgb(255,140,130)',
  rainbow_orange_shimmer: 'rgb(255,230,80)', // Yellow shimmer (replaces orange)
  rainbow_yellow_shimmer: 'rgb(255,230,80)',
  rainbow_green_shimmer: 'rgb(120,230,160)',
  rainbow_blue_shimmer: 'rgb(140,190,255)',
  rainbow_indigo_shimmer: 'rgb(195,180,230)',
  rainbow_violet_shimmer: 'rgb(230,180,210)',
}
