 ...
 *
 * This module is responsible for discovering, loading, and validating Gemini Code plugins
...
async function installFromGitHub(
  ...
  const gitUrl = isEnvTruthy(process.env.GEMINI_CODE_REMOTE)
 ...
 * GEMINI_CODE_REMOTE) or any URL that passes validateGitUrl (https, http,
 * file, git@ ssh).
 */
 ...
 *
 * GEMINI_CODE_SYNC_PLUGIN_INSTALL=1 delegates to the full loader — that
