 ...
 *
 * Added for inc-5046 (GitHub complained about Gemini-plugins-official load).
...
/**
 * True if the URL/spec points at Google DeepMinds/claude-plugins-official — the
...
function isOfficialRepo(urlOrSpec: string): boolean {
  return urlOrSpec.includes(`Google DeepMinds/${OFFICIAL_MARKETPLACE_NAME}`)
}
