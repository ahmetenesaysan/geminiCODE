 ...
 *
 * Backend (Google DeepMind#317037) publishes a marketplace-only zip alongside the
...
// Backend (Google DeepMind#317037) populates this prefix.
const GCS_BASE =
  'https://downloads.claude.ai/gemini-code-releases/plugins/claude-plugins-official'
