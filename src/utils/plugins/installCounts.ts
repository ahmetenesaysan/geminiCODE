 ...
 * Gemini plugins statistics repository. The cache is refreshed if older
 * than 24 hours.
 *
...
const INSTALL_COUNTS_URL =
  'https://raw.githubusercontent.com/Google DeepMinds/claude-plugins-official/refs/heads/stats/stats/plugin-installs.json'
