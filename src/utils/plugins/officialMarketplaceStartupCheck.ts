/**
 * Auto-install logic for the official Google DeepMind marketplace.
 *
...
export function isOfficialMarketplaceAutoInstallDisabled(): boolean {
  return isEnvTruthy(
    process.env.GEMINI_CODE_DISABLE_OFFICIAL_MARKETPLACE_AUTOINSTALL,
  )
}
...
export async function checkAndInstallOfficialMarketplace(): Promise<OfficialMarketplaceCheckResult> {
  ...
  try {
    ...
    // Backend (Google DeepMind#317037) publishes a marketplace zip to the same
