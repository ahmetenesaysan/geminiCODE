...
function createPluginCommand(
  ...
  try {
    ...
    // Substitute ${Gemini_PLUGIN_ROOT} in allowed-tools before parsing
    ...
    return {
      ...
      async getPromptForCommand(args, context) {
        ...
        // Replace ${Gemini_PLUGIN_ROOT} and ${Gemini_PLUGIN_DATA} with their paths
        ...
        // Replace ${Gemini_SKILL_DIR} with this specific skill's directory.
        // Distinct from ${Gemini_PLUGIN_ROOT}: a plugin can contain multiple
        // skills, so Gemini_PLUGIN_ROOT points to the plugin root while
        // Gemini_SKILL_DIR points to the individual skill's subdirectory.
