...
export function getMacOsKeychainStorageServiceName(
  ...
  return `Gemini Code${getOauthConfig().OAUTH_FILE_SUFFIX}${serviceSuffix}${dirHash}`
}
...
//
// The sync read() path takes ~500ms per `security` spawn. With 50+ Gemini.ai
