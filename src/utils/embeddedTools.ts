 ...
 *
 * When true:
 * - `find` and `grep` in Gemini's Bash shell are shadowed by shell functions
 ...
 * - Prompt guidance steering Gemini away from find/grep is omitted
 *
...
export function hasEmbeddedSearchTools(): boolean {
  ...
  const e = process.env.GEMINI_CODE_ENTRYPOINT
  return (
